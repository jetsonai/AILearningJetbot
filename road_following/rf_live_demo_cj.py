...
def executeModel(image):
    ...
    dangle = angle*180/3.14
    print('model x %f, y %f, degree %f' % (x, y, dangle))
    ...
    print('left_motor x %f, right_motor %f' % (left_motor_value, right_motor_value))	
...
model.load_state_dict(torch.load('best_model_cj.pth'))
